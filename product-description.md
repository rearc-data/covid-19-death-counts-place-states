...
The source code outlining how this product gathers, transforms, revises and publishes its datasets is available at [https://github.com/rearc-data/covid-19-death-counts-place-states](https://github.com/rearc-data/covid-19-death-counts-place-states).
...
`"data_as_of", "state", "place_of_death", "start_week", "end_week", "covid19_deaths", "total_deaths", "pneumonia_deaths", "pneumonia_and_covid19_deaths", "influenza_deaths", "pneumonia_influenza_and", "footnote"`
...
## Contact Details
- If you find any issues or have enhancements with this product, open up a GitHub [issue](https://github.com/rearc-data/covid-19-death-counts-place-states/issues) and we will gladly take a look at it. Better yet, submit a pull request. Any contributions you make are greatly appreciated :heart:.
